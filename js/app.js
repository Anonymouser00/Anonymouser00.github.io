...
function selectCompVideo(methodPill, scenePill, n_views, modePill) {
    ...
    switch (pill) {
        ...
        case 'sea':
            ...
            break;
        case 'ship':
            promptTextBox.text("At night, a small boat in the center of the ocean is surrounded by dark clouds and waves, and glowing lights emanate from above, creating a mysterious atmosphere that showcases the vastness of water and sky. ");
            break;
        case 'b2':
            promptTextBox.text("An aerial scene of dark cloud layers, with many airplanes traversing the sky, amid thunder and lightning, an apocalyptic scenario, surrealism.");
            break;
        case 'snowtown':
